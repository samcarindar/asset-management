...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 22, 2022 at 12:19 PM
...
CREATE TABLE `book` (
  ...
  `b_name` varchar(50) COLLATE utf8mb3_unicode_ci NOT NULL,
  `c_id` int(11) NOT NULL,
  `status` varchar(11) COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'ปกติ/ว่าง',
  `price` int(11) NOT NULL,
  `book_id` varchar(20) COLLATE utf8mb3_unicode_ci NOT NULL
...
(1, '31002', 1, '2022-02-22 09:58:20', '2022-02-25 17:00:00', 230, 2, 0),
(2, '31004', 2, '2022-02-22 09:59:47', '2022-02-25 17:00:00', 230, 1, 1);
...
CREATE TABLE `category` (
  `c_id` int(11) NOT NULL,
  `c_name` varchar(50) COLLATE utf8mb3_unicode_ci NOT NULL,
  `c_number` varchar(10) COLLATE utf8mb3_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `member` (
  `m_id` int(11) NOT NULL,
  `m_card_id` varchar(13) COLLATE utf8mb3_unicode_ci NOT NULL,
  `m_name` varchar(60) COLLATE utf8mb3_unicode_ci NOT NULL,
